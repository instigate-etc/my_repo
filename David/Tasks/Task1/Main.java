...
public class Main {
	...
	private int mMax = 0;
	private int MultiplyByRight(int beginPointI,int beginPointJ,int [][]array) {
		int multiply = 1;
		try {
	...
	private int MultiplyByDown(int beginPointI,int beginPointJ,int [][]array) {
		int multiply = 1;
		try {
	...
	private int MultiplyByDiagonalByRight(int beginPointI,int beginPointJ,int [][]array) {
		int multiply = 1;
		try {
	...
	private int MultiplyByDiagonalByLeft(int beginPointI,int beginPointJ,int [][] array) {
		int multiply = 1;
		try {
